...
..B1.4:                         # Preds ..B1.3
        ...
        movq      %r9, %r10                                     #15.3
        andq      $-256, %r10                                   #15.3
        movq      $0xf000000000, %r13                           #15.3
        shrq      $8, %r10                                      #15.3
        andq      %r13, %r9                                     #15.3
        movl      152(%rsp), %ebx                               #14.3
        movq      $0xffffff0fffffffff, %r12                     #15.3
        movslq    %ebx, %r13                                    #15.3
        movl      $16, %r8d                                     #15.3
        shlq      $63, %r10                                     #15.3
        movq      %r13, %rdx                                    #15.3
        ...
        sarq      $63, %rdx                                     #15.3
        andq      %r12, %r10                                    #15.3
        movl      156(%rsp), %r14d                              #13.3
        xorl      %r12d, %r12d                                  #15.3
        movq      %r12, 16+heat_$PHI.0.1(%rip)                  #15.3
        lea       1(%r13), %r15                                 #15.3
        movq      %r12, 64+heat_$PHI.0.1(%rip)                  #15.3
        notq      %rdx                                          #15.3
        movq      %r12, 88+heat_$PHI.0.1(%rip)                  #15.3
        andq      %r15, %rdx                                    #15.3
        ...
        notq      %rcx                                          #15.3
        lea       (,%rdx,8), %rdi                               #15.3
        movq      %rdi, 80+heat_$PHI.0.1(%rip)                  #15.3
        lea       1(%r12), %rsi                                 #15.3
        andq      %rsi, %rcx                                    #15.3
        movl      $3, %esi                                      #15.3
        imulq     %rcx, %rdi                                    #15.3
        ...
        shlq      $60, %r9                                      #15.3
        shrq      $24, %r9                                      #15.3
        movq      %rdi, 104+heat_$PHI.0.1(%rip)                 #15.3
...
..B1.28:                        # Preds ..B1.28 ..B1.27
        ...
        jb        ..B1.28       # Prob 82%                      #22.6
                                # LOE rax rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 edx ymm0
..B1.30:                        # Preds ..B1.28 ..B1.8 ..B1.21 ..B1.26
                                # Execution count [5.44e+00]
        incq      %rcx                                          #21.3
        addq      %r9, %rax                                     #21.3
...
..B1.33:                        # Preds ..B1.32
        ...
        movq      80+heat_$PHI.0.1(%rip), %rax                  #30.6
        lea       1(%r13), %rcx                                 #14.3
        movq      104+heat_$PHI.0.1(%rip), %rdx                 #30.6
        movq      heat_$PHI.0.1(%rip), %rsi                     #30.6
        cmpq      $8, %rcx                                      #29.3
        jl        ..B1.95       # Prob 10%                      #29.3
                                # LOE rax rdx rcx rsi r12 r13 ebx r8d r14d
..B1.34:                        # Preds ..B1.33
                                # Execution count [4.35e-01]
        movq      %rsi, %rdi                                    #31.6
        subq      %rdx, %rdi                                    #31.6
        lea       (%rdi,%rdx,2), %r9                            #31.6
        movq      %r9, 64(%rsp)                                 #31.6[spill]
        cmpq      $15, %rcx                                     #29.3
        jl        ..B1.97       # Prob 10%                      #29.3
                                # LOE rax rdx rcx rsi r9 r12 r13 ebx r8d r14d
..B1.35:                        # Preds ..B1.34
                                # Execution count [4.35e-01]
        andq      $31, %r9                                      #29.3
        testl     %r9d, %r9d                                    #29.3
        je        ..B1.38       # Prob 50%                      #29.3
                                # LOE rax rdx rcx rsi r12 r13 ebx r8d r9d r14d
..B1.36:                        # Preds ..B1.35
                                # Execution count [4.35e-01]
        testl     $7, %r9d                                      #29.3
        jne       ..B1.95       # Prob 10%                      #29.3
                                # LOE rax rdx rcx rsi r12 r13 ebx r8d r9d r14d
..B1.37:                        # Preds ..B1.36
        ...
        shrl      $3, %r9d                                      #29.3
                                # LOE rax rdx rcx rsi r12 r13 ebx r8d r9d r14d
..B1.38:                        # Preds ..B1.37 ..B1.35
                                # Execution count [4.35e-01]
        movl      %r9d, %r9d                                    #29.3
        movq      %r9, 80(%rsp)                                 #29.3[spill]
        lea       8(%r9), %rdi                                  #29.3
        cmpq      %rdi, %rcx                                    #29.3
        jl        ..B1.95       # Prob 10%                      #29.3
                                # LOE rax rdx rcx rsi r12 r13 ebx r8d r9d r14d
..B1.39:                        # Preds ..B1.38
        ...
        subq      %rdx, %r10                                    #30.6
        subl      %r9d, %r8d                                    #29.3
        lea       (%rdx,%rsi), %r11                             #30.6
        andl      $7, %r8d                                      #29.3
        lea       (%rsi,%rdx,2), %r15                           #30.6
        subl      %r8d, %edi                                    #29.3
        addq      %r10, %r11                                    #30.6
        addq      %r15, %r10                                    #30.6
        xorl      %r8d, %r8d                                    #29.3
        ...
        movslq    %edi, %rdi                                    #29.3
        testl     %r9d, %r9d                                    #29.3
        jbe       ..B1.43       # Prob 56%                      #29.3
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 ebx r14d xmm2
..B1.40:                        # Preds ..B1.39
                                # Execution count [4.35e-01]
        ...
        movq      64(%rsp), %r9                                 #[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 r15 ebx r14d xmm2
..B1.41:                        # Preds ..B1.41 ..B1.40
                                # Execution count [4.90e+00]
        vmovsd    %xmm2, (%r11,%r8,8)                           #30.6
        movq      %r15, (%rsi,%r8,8)                            #31.6
...
..B1.42:                        # Preds ..B1.41
                                # Execution count [4.35e-01]
        movq      %rdx, 80(%rsp)                                #[spill]
        movq      72(%rsp), %rdx                                #[spill]
                                # LOE rax rdx rcx rsi rdi r10 r11 r12 r13 ebx r14d xmm2
..B1.43:                        # Preds ..B1.39 ..B1.42 ..B1.97
                                # Execution count [4.35e-01]
        vmovupd   .L_2il0floatpacket.2(%rip), %ymm1             #30.6
        vxorpd    %ymm0, %ymm0, %ymm0                           #31.6
        movq      80(%rsp), %r8                                 #31.6[spill]
        movq      64(%rsp), %r9                                 #31.6[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 ebx r14d xmm2 ymm0 ymm1
..B1.44:                        # Preds ..B1.44 ..B1.43
                                # Execution count [4.90e+00]
        vmovupd   %ymm1, (%r11,%r8,8)                           #30.6
        vmovupd   %ymm1, 32(%r11,%r8,8)                         #30.6
        vmovupd   %ymm0, (%rsi,%r8,8)                           #31.6
        vmovupd   %ymm0, 32(%rsi,%r8,8)                         #31.6
        vmovupd   %ymm1, (%r10,%r8,8)                           #30.6
        vmovupd   %ymm1, 32(%r10,%r8,8)                         #30.6
        vmovupd   %ymm0, (%r9,%r8,8)                            #31.6
        vmovupd   %ymm0, 32(%r9,%r8,8)                          #31.6
        addq      $8, %r8                                       #29.3
        cmpq      %rdi, %r8                                     #29.3
...
..B1.45:                        # Preds ..B1.44
                                # Execution count [4.35e-01]
        movl      %edi, %r8d                                    #32.3
                                # LOE rax rdx rcx rsi r12 r13 ebx edi r8d r14d xmm2
..B1.46:                        # Preds ..B1.45 ..B1.95
                                # Execution count [1.00e+00]
        movslq    %edi, %rdi                                    #29.3
        cmpq      %rcx, %rdi                                    #29.3
        jae       ..B1.51       # Prob 56%                      #29.3
                                # LOE rax rdx rcx rsi rdi r12 r13 ebx r8d r14d xmm2
..B1.47:                        # Preds ..B1.46
                                # Execution count [4.35e-01]
        imulq     %r12, %rax                                    #30.6
        movq      %rsi, %r8                                     #31.6
        ...
        lea       (%rdx,%rsi), %r9                              #30.6
        addq      %rax, %r9                                     #30.6
        lea       (%r8,%rdx,2), %r8                             #31.6
        lea       (%rsi,%rdx,2), %rdx                           #30.6
        addq      %rdx, %rax                                    #30.6
        xorl      %edx, %edx                                    #30.6
                                # LOE rax rdx rcx rsi rdi r8 r9 r12 r13 ebx r14d xmm2
..B1.48:                        # Preds ..B1.48 ..B1.47
                                # Execution count [4.90e+00]
        vmovsd    %xmm2, (%r9,%rdi,8)                           #30.6
        movq      %rdx, (%rsi,%rdi,8)                           #31.6
        vmovsd    %xmm2, (%rax,%rdi,8)                          #30.6
        movq      %rdx, (%r8,%rdi,8)                            #31.6
        incq      %rdi                                          #29.3
        cmpq      %rcx, %rdi                                    #29.3
...
..B1.52:                        # Preds ..B1.51
                                # Execution count [4.35e-01]
        movq      80+heat_$PHI.0.1(%rip), %rcx                  #34.6
        incl      %r14d                                         #13.3
        movq      104+heat_$PHI.0.1(%rip), %rsi                 #34.6
        movl      152(%rsp), %edi                               #34.27
        movq      heat_$PHI.0.1(%rip), %rax                     #34.6
        testq     %rcx, %rcx                                    #55.82
        je        ..B1.101      # Prob 10%                      #55.82
                                # LOE rax rcx rsi r12 r13 ebx edi r8d r14d
..B1.53:                        # Preds ..B1.52
                                # Execution count [4.35e-01]
        cmpl      $8, %r14d                                     #33.3
        jl        ..B1.100      # Prob 10%                      #33.3
                                # LOE rax rcx rsi r12 r13 ebx edi r8d r14d
..B1.54:                        # Preds ..B1.53
                                # Execution count [4.35e-01]
        ...
        xorl      %r15d, %r15d                                  #33.3
        subq      %rsi, %r11                                    #35.6
        vmovq     %xmm2, 64(%rsp)                               #34.6[spill]
        lea       (%r10,%rsi,2), %r9                            #34.6
        movq      %r9, 72(%rsp)                                 #34.6[spill]
        lea       (%rsi,%rax), %r10                             #35.6
        lea       (%rax,%rsi,2), %r9                            #35.6
        movl      %edx, 88(%rsp)                                #34.6[spill]
        addq      %r11, %r10                                    #35.6
        movq      %rsi, 96(%rsp)                                #34.6[spill]
        addq      %r9, %r11                                     #35.6
        movl      %edi, 104(%rsp)                               #34.6[spill]
        lea       (%rcx,%rcx,2), %r9                            #34.6
        movl      %r8d, 112(%rsp)                               #34.6[spill]
        movl      %r14d, 120(%rsp)                              #34.6[spill]
        movq      %r15, %r8                                     #34.6
        movq      %rdx, %rdi                                    #34.6
        movq      72(%rsp), %rdx                                #34.6[spill]
        movq      64(%rsp), %rsi                                #34.6[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 r15 ebx
..B1.55:                        # Preds ..B1.55 ..B1.54
                                # Execution count [4.90e+00]
        addq      $8, %r15                                      #33.3
        lea       (%rax,%r8), %r14                              #34.6
        movq      %rsi, (%r14)                                  #34.6
        movq      %rsi, (%rcx,%r14)                             #34.6
        movq      %rsi, (%r14,%rcx,2)                           #34.6
        movq      %rsi, (%r9,%r14)                              #34.6
        lea       (%r14,%rcx,4), %r14                           #34.6
        movq      %rsi, (%r14)                                  #34.6
        movq      %rsi, (%rcx,%r14)                             #34.6
        movq      %rsi, (%r14,%rcx,2)                           #34.6
        movq      %rsi, (%r9,%r14)                              #34.6
        lea       (%r10,%r8), %r14                              #35.6
        movq      %rsi, (%r14)                                  #35.6
        movq      %rsi, (%rcx,%r14)                             #35.6
        movq      %rsi, (%r14,%rcx,2)                           #35.6
        movq      %rsi, (%r9,%r14)                              #35.6
        lea       (%r14,%rcx,4), %r14                           #35.6
        movq      %rsi, (%r14)                                  #35.6
        movq      %rsi, (%rcx,%r14)                             #35.6
        movq      %rsi, (%r14,%rcx,2)                           #35.6
        movq      %rsi, (%r9,%r14)                              #35.6
...
..B1.56:                        # Preds ..B1.55
                                # Execution count [4.35e-01]
        movl      88(%rsp), %edx                                #[spill]
        movl      120(%rsp), %r14d                              #[spill]
        movq      96(%rsp), %rsi                                #[spill]
        movl      104(%rsp), %edi                               #[spill]
        movl      112(%rsp), %r8d                               #[spill]
                                # LOE rax rcx rsi r12 r13 edx ebx edi r8d r14d
..B1.57:                        # Preds ..B1.56 ..B1.100
...
..B1.58:                        # Preds ..B1.57
        ...
        jl        ..B1.99       # Prob 10%                      #33.3
                                # LOE rax rcx rsi r9 r12 r13 r14 edx ebx edi r8d
..B1.59:                        # Preds ..B1.58
                                # Execution count [4.35e-01]
        vxorpd    %xmm0, %xmm0, %xmm0                           #34.19
        vxorpd    %xmm1, %xmm1, %xmm1                           #34.27
        ...
        andl      $-2, %r15d                                    #33.3
        movl      %edx, 88(%rsp)                                #33.3[spill]
        movq      %rsi, 96(%rsp)                                #33.3[spill]
        lea       (%r11,%rsi,2), %r11                           #35.6
        addq      %rax, %r11                                    #35.6
        addq      %r9, %r11                                     #35.6
        movq      %r11, 64(%rsp)                                #35.6[spill]
        movq      %rax, %r11                                    #34.6
        subq      %rsi, %r11                                    #34.6
        movl      %edi, 104(%rsp)                               #33.3[spill]
        movl      %r8d, 112(%rsp)                               #33.3[spill]
        movslq    %r15d, %r15                                   #33.3
        movq      %r14, 120(%rsp)                               #33.3[spill]
        lea       (%r11,%rsi,2), %r11                           #34.6
        addq      %r9, %r11                                     #34.6
        movq      %r11, 80(%rsp)                                #34.6[spill]
        lea       (%rax,%r13,8), %r11                           #35.6
        movq      %r10, %r8                                     #33.3
        addq      %r9, %r11                                     #35.6
        movq      72(%rsp), %rdi                                #33.3[spill]
        addq      %rax, %r9                                     #34.6
        movq      80(%rsp), %rdx                                #33.3[spill]
...
..B1.60:                        # Preds ..B1.60 ..B1.59
        ...
        lea       (%r8,%r9), %r14                               #34.6
        movq      %rdi, (%r14)                                  #34.6
        movq      %rdi, (%rcx,%r14)                             #34.6
        lea       (%r8,%r11), %r14                              #35.6
        movq      %rdi, (%r14)                                  #35.6
        movq      %rdi, (%rcx,%r14)                             #35.6
        lea       (%r8,%rdx), %r14                              #34.6
        movq      %rdi, (%r14)                                  #34.6
        movq      %rdi, (%rcx,%r14)                             #34.6
        lea       (%r8,%rsi), %r14                              #35.6
        movq      %rdi, (%r14)                                  #35.6
        lea       (%r8,%rcx,2), %r8                             #33.3
        movq      %rdi, (%rcx,%r14)                             #35.6
        cmpq      %r15, %r10                                    #33.3
...
..B1.61:                        # Preds ..B1.60
        ...
        movl      104(%rsp), %edi                               #[spill]
        movl      112(%rsp), %r8d                               #[spill]
                                # LOE rax rcx rsi r12 r13 r14 r15 edx ebx edi r8d
..B1.62:                        # Preds ..B1.61 ..B1.99 ..B1.102
                                # Execution count [1.00e+00]
        movq      %rcx, %r9                                     #33.3
        imulq     %r15, %r9                                     #33.3
        cmpq      %r14, %r15                                    #33.3
        jae       ..B1.66       # Prob 56%                      #33.3
                                # LOE rax rcx rsi r9 r12 r13 r14 r15 edx ebx edi r8d
..B1.63:                        # Preds ..B1.62
                                # Execution count [4.35e-01]
        movslq    %edx, %rdx                                    #34.6
        vxorpd    %xmm0, %xmm0, %xmm0                           #34.19
        ...
        lea       (%r8,%rsi,2), %r8                             #35.6
        addq      %rax, %r8                                     #35.6
        lea       (%rdi,%rsi,2), %rdi                           #34.6
        addq      %rdx, %r8                                     #35.6
        lea       (%rax,%r13,8), %rsi                           #35.6
        addq      %rdx, %rdi                                    #34.6
        addq      %rdx, %rsi                                    #35.6
        addq      %rdx, %rax                                    #34.6
                                # LOE rax rcx rsi rdi r8 r9 r12 r13 r14 r15 ebx xmm0
..B1.64:                        # Preds ..B1.64 ..B1.63
                                # Execution count [4.90e+00]
        incq      %r15                                          #33.3
        vmovsd    %xmm0, (%r9,%rax)                             #34.6
        vmovsd    %xmm0, (%r9,%rsi)                             #35.6
        vmovsd    %xmm0, (%r9,%rdi)                             #34.6
        vmovsd    %xmm0, (%r9,%r8)                              #35.6
        addq      %rcx, %r9                                     #33.3
        cmpq      %r14, %r15                                    #33.3
        jb        ..B1.64       # Prob 91%                      #33.3
                                # LOE rax rcx rsi rdi r8 r9 r12 r13 r14 r15 ebx xmm0
..B1.66:                        # Preds ..B1.64 ..B1.51 ..B1.101 ..B1.57 ..B1.62
                                #      
...
..B1.67:                        # Preds ..B1.105 ..B1.66 ..B1.86
...
..B1.84:                        # Preds ..B1.83
                                # Execution count [2.28e+00]
        xorl      %eax, %eax                                    #67.8
        lea       184(%rsp), %rdi                               #67.8
        lea       160(%rsp), %rsi                               #67.8
        lea       1(%r15), %r13d                                #50.3
...
..B1.85:                        # Preds ..B1.84
                                # Execution count [2.33e+00]
        vmovsd    184(%rsp), %xmm3                              #68.3
        vmovsd    168(%rsp), %xmm2                              #68.3
...
..B1.86:                        # Preds ..B1.85
        ...
        jl        ..B1.67       # Prob 80%                      #44.36
                                # LOE ebx r12d r13d r14d r15d xmm2 xmm3
..B1.87:                        # Preds ..B1.105 ..B1.85 ..B1.86
...
..B1.97:                        # Preds ..B1.34
        ...
        lea       (%rdx,%rsi), %r11                             #30.6
        movslq    %edi, %rdi                                    #29.3
        lea       (%rsi,%rdx,2), %r8                            #30.6
        movq      $0, 80(%rsp)                                  #29.3[spill]
        addq      %r10, %r11                                    #30.6
        addq      %r8, %r10                                     #30.6
        jmp       ..B1.43       # Prob 100%                     #30.6
                                # LOE rax rdx rcx rsi rdi r10 r11 r12 r13 ebx r14d xmm2
..B1.99:                        # Preds ..B1.58
                                # Execution count [4.35e-02]: Infreq
        xorl      %r15d, %r15d                                  #33.3
...
..B1.104:                       # Preds ..B1.68
        ...
        lea       184(%rsp), %rdi                               #67.8
        lea       160(%rsp), %rsi                               #67.8
..___tag_value_MAIN__.100:
        call      timing_                                       #67.8
..___tag_value_MAIN__.101:
                                # LOE ebx r12d r13d r14d r15d
..B1.105:                       # Preds ..B1.104
